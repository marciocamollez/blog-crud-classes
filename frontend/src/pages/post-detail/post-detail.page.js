    ...
    render() {
        return (
            <div className="container">
                ...
                <PageTop title={"Posts"} desc={"Detalhes dos posts"}>
                    <button className="btn btn-primary" onClick={() => this.props.history.goBack()}>Voltar</button>
                </PageTop>
                ...
                <div className="row">
                    <div className="col-6">
                        <img className="post-img" src={this.state?.post?.imageUrl} alt="imagem do Post" />
                    </div>
                    <div className="col-6">
